...
class InpaintGenerator(BaseNetwork):
    def __init__(self, init_weights=True, flow_align=True, skip_dcn=False, flow_guide=False,
        ...
        channel = 256   # default size
        hidden = 512    # default size
        reduction = 1   # default size

        depths = 8  # default size
        ...
        self.encoder = Encoder(out_channel=channel // 2, reduction=reduction)   # equal to default when reduction = 1
